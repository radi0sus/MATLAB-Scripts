...
% +++++++++++++++++++++++++++++++++++++++++++++++++++++++
% No equilibrium: t(1/2)_mother < t(1/2)_daugther
% -------------------------------------------------------
...
l1_v = log(2)/3.05; % insert t(1/2) for 1, l=log(2)/t(1/2)
l2_v = log(2)/26.8;             % insert t(1/2) for 2, l=log(2)/t(1/2)
...
%plot options
ax1.Title.String = {'No equilibrium','Po-218 \rightarrow Pb-214'};
ax1.YLim=[0.01 1.1];
ax1.XLim=[0 30];
ax1.XLabel.String='t /min';
ax1.YLabel.String='rel. Activity (A/A0)';
legend('Po (t(1/2) = 3.05 min)','Pb (t(1/2) = 26.8 min)','sum');
...
%plot options
ax2.Title.String = {'No equilibrium','Po-218 \rightarrow Pb-214'};
ax2.YScale='log';
ax2.YLim=[0.01 1.1];
ax2.XLim=[0 50];
